...
export default class ShopScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image('Bandage', new URL('../../assets/Bandage.png', import.meta.url).href);
    ...
    this.load.image('shield', new URL('../../assets/Shield_Icon.png', import.meta.url).href);
    this.load.image('UpBtn', new URL('../../assets/UpBtnIcon.png', import.meta.url).href);
    this.load.image('zerobtn', new URL('../../assets/Willy_Death.png', import.meta.url).href);
    this.load.image('shot', new URL('../../assets/bulletIcon.png', import.meta.url).href);
  }
  ...
  create() {
    ...
    this.InvBG = this.add.image(635, 360, 'InvBG').setScale(0.85);
    ...
    this.bandage = this.physics.add
      .sprite(575, 170, 'Bandage')
      .setScale(4, 4)
      .setOrigin(0)
      .setInteractive({
        useHandCursor: true,
    ...
    this.boots = this.physics.add
      .sprite(575, 490, 'speed')
      .setScale(4, 4)
      .setOrigin(0)
      .setInteractive({
        useHandCursor: true,
    ...
    this.shield = this.physics.add
      .sprite(575, 810, 'shield')
      .setScale(4, 4)
      .setOrigin(0)
      .setInteractive({
        useHandCursor: true,
  ...
  displaySection(description, cost, image, callback) {
    this.description = this.add.image(250, 360, 'ItemDesc').setScale(0.8);
